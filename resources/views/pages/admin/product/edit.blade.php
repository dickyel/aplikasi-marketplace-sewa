...
@section('title')
    Swa Mobile Dashboard Edit Produk Admin
@endsection
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="users_id" class="form-control">
                                        <option value="{{ $item->users_id }}">{{ $item->user->store_name }}</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="day" value="{{ $item->day }}" required />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
