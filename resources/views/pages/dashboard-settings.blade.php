...
@section('title')
    Swa Mobile Dashboard Pengaturan
@endsection
    ...
    <div class="container-fluid">
      <div class="dashboard-heading">
        ...
        <p class="dashboard-subtitle">
          Jadikan Toko Sewamu Lebih Profesional
        </p>
      </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label >Alamat Url Maps</label>
                        <input
                          type="text"
                          class="form-control"
                          name="maps_store"
                          value="{{ $user->maps_store }}"
                        />
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="store_status">Status Toko</label>
                        <p class="text-muted">
